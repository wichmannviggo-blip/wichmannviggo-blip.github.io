(function(){
  ...
  /* =========================================================
     ...
     nerve the shot takes. 50 per difficulty now (150 total), giving
     plenty of headroom over the 16 daily hour-slots. Each carries a
     fixed xp reward.
     ========================================================= */
  ...
  const EASY_QUESTS = [
    ...
    "Take a photo of something completely blue.",
    ...
    "Take a photo of a bicycle.",
    "Take a photo of a bird.",
    "Take a photo of a bench.",
    "Take a photo of a door.",
    "Take a photo of a window.",
    "Take a photo of a street sign.",
    "Take a photo of something rusty.",
    "Take a photo of something shiny.",
    "Take a photo of something round.",
    "Take a photo of something triangular.",
    "Take a photo of something made of wood.",
    "Take a photo of something made of metal.",
    "Take a photo of something reflected.",
    "Take a photo of a shadow.",
    "Take a photo of something with a pattern.",
    "Take a photo of something old.",
    "Take a photo of something new.",
    "Take a photo of something tiny.",
    "Take a photo of something huge.",
    "Take a photo of a staircase.",
    "Take a photo of a fence.",
    "Take a photo of a lamp.",
    "Take a photo of a vehicle.",
    "Take a photo of a sign.",
    "Take a photo of something growing.",
    "Take a photo of something broken.",
    "Take a photo of something symmetrical.",
    "Take a photo of something with a face-like shape.",
    "Take a photo through a window.",
    "Take a photo looking straight up.",
    "Take a photo looking straight down.",
    "Take a photo of something in motion.",
    "Take a photo of something in the distance.",
    "Take a photo of something casting a shadow.",
    "Take a photo of something with three different colors.",
    "Take a photo of something you normally wouldn't notice.",
  ...
  const MEDIUM_QUESTS = [
    "Take a photo of a yellow flower.",
    "Take a photo of a red car.",
    "Take a photo of a black bird.",
    "Take a photo of a white dog.",
    "Take a photo of a butterfly.",
    "Take a photo of a pine tree.",
    "Take a photo of a dandelion.",
    "Take a photo of a rose.",
    "Take a photo of a cloud shaped like an animal.",
    "Take a photo of a bird sitting on a wire.",
    "Take a photo of a red door.",
    "Take a photo of a blue bicycle.",
    "Take a photo of a car with its headlights on.",
    "Take a photo of a person wearing a hat, from an appropriate distance.",
    "Take a photo of a street with no cars.",
    "Take a photo of a building with visible bricks.",
    "Take a photo of a window with curtains.",
    "Take a photo of a tree growing somewhere unusual.",
    "Take a photo of two different flowers in the same frame.",
    "Take a photo of three birds together.",
    "Take a photo of water reflecting the sky.",
    "Take a photo of a reflection in glass.",
    "Take a photo of a reflection in a puddle.",
    "Take a photo of a shadow that looks like something else.",
    "Take a photo of something covered in moss.",
    "Take a photo of something covered in raindrops.",
    "Take a photo of a perfectly circular object.",
    "Take a photo of something with stripes.",
    "Take a photo of something with polka dots.",
    "Take a photo of something with a spiral.",
    "Take a photo of a pair of matching objects.",
    "Take a photo of an abandoned-looking object.",
    "Take a photo of a bicycle with a basket.",
    "Take a photo of a yellow road sign.",
    "Take a photo of a street name containing the letter A.",
    "Take a photo of a clock showing the time.",
    "Take a photo of a doorway with a number on it.",
    "Take a photo of a vehicle with an unusual color.",
    "Take a photo of a flower growing through concrete.",
    "Take a photo of a leaf with a hole in it.",
    "Take a photo of a tree with exposed roots.",
    "Take a photo of a bird in flight.",
    "Take a photo of a dog looking directly toward the camera.",
    "Take a photo of a cat sitting in a window.",
    "Take a photo of something shaped like a heart.",
    "Take a photo of a natural object shaped like a letter.",
    "Take a photo of two shadows overlapping.",
    "Take a photo of a naturally occurring line of objects.",
    "Take a photo of something with exactly three visible colors.",
    "Take a photo of a subject hidden behind something else."
  ];

  const HARD_QUESTS = [
    "Take a photo of a ladybug sitting on a green leaf.",
    "Take a photo of a bee collecting pollen from a flower.",
    "Take a photo of a yellow flower with a butterfly nearby.",
    "Take a photo of three different species of bird in one photo.",
    "Take a photo of a bird sitting on top of a street sign.",
    "Take a photo of a red flower with raindrops on its petals.",
    "Take a photo of a white flower growing through a crack in concrete.",
    "Take a photo of a spider web covered in morning dew.",
    "Take a photo of a leaf with a perfectly visible water droplet.",
    "Take a photo of two different flowers sharing the same stem or area.",
    "Take a photo of a reflection containing both the sky and a building.",
    "Take a photo of a puddle reflecting a person or object.",
    "Take a photo of a shadow that clearly resembles an animal.",
    "Take a photo of a natural object forming a recognizable letter.",
    "Take a photo of a tree with a branch forming a natural arch.",
    "Take a photo of a perfectly symmetrical reflection.",
    "Take a photo of a red object reflected in water.",
    "Take a photo of a bird reflected in a window.",
    "Take a photo of a vehicle reflected in a puddle.",
    "Take a photo of a flower growing somewhere completely unexpected.",
    "Take a photo of a building where every visible window is different.",
    "Take a photo of a street containing three different types of vehicles.",
    "Take a photo of a street sign reflected in glass.",
    "Take a photo of a door with a number containing two identical digits.",
    "Take a photo of a building with exactly three visible floors.",
    "Take a photo of a red door surrounded by greenery.",
    "Take a photo of a bicycle with something unusual attached to it.",
    "Take a photo of two identical objects separated by something different.",
    "Take a photo of five objects arranged naturally in a straight line.",
    "Take a photo of something tiny appearing enormous because of perspective.",
    "Take a photo of something enormous appearing tiny because of perspective.",
    "Take a photo where one object visually appears to sit on top of another.",
    "Take a photo containing exactly five clearly visible colors.",
    "Take a photo containing three different textures.",
    "Take a photo of something naturally shaped like a human face.",
    "Take a photo of two completely different objects that look almost identical.",
    "Take a photo of a natural spiral.",
    "Take a photo of a perfectly circular natural object.",
    "Take a photo of a flower with an insect on it.",
    "Take a photo of a bird perched somewhere unusual.",
    "Take a photo of a cloud that strongly resembles a recognizable object.",
    "Take a photo of a reflection where the reflected scene looks different from reality.",
    "Take a photo of a shadow containing the silhouette of two people or objects.",
    "Take a photo of a single object surrounded by an otherwise empty scene.",
    "Take a photo of something colorful hidden in an otherwise dull scene.",
    "Take a photo of a natural object creating a perfect frame around another object.",
    "Take a photo of a repeating pattern containing at least 10 repetitions.",
    "Take a photo of three identical objects at three different distances.",
    "Take a photo where foreground, middle ground, and background each contain a different subject.",
    "Take a photo of something you searched for for at least 10 minutes before finding."
  ];
